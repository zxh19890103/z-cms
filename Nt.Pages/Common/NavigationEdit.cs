...
{
    public class NavigationEdit : NtPageForEditAsTree<Nt_Navigation>
    {
        ...
        {
            ParentName = CommonFactoryAsTree.GetFullName("Nt_Navigation", Model.Parent);
