...
namespace Nt.BLL
{
    public class NavigationService : BaseServiceAsTree<Nt_Navigation>
    {
        public void CopyAllDataTo(int[] targetLangs, string[] replaceItems)
        {
            ...
            string rawcopyScript = File.ReadAllText(WebHelper.MapPath("/App_Data/Script/copy.tree.navigation.sql"));
