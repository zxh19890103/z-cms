        ...
        <div class="content_in">
            ...
            <div class="content_right">
                <div class="position">
                    ...
                    <a href="/">首 页</a>   > <a href="/research/">研究中心</a>   >   <%=CurrentCategoryName %>
                </div>
                <a class="gotoback" href="javascript:window.history.go(-1)">返回</a>
				
				 <%
				 Response.Write("<div class=\"Research_short\">");
            	 Response.Write("<h1>我们的团队</h1>");
                 Response.Write("<h2>Our team</h2>");
                 Response.Write("<span></span>");
                 Response.Write("<p>我们的团队是独一无二的，共同的信念使我们走到一起</p>");
				 Response.Write(" <strong>Our team is the one and only, the common belief that we come together</strong>");
              %>
            </div>
                <div class="team_list">
                    <ul>
