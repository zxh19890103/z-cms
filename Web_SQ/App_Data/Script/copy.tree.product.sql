...
begin
	...
	begin
         ...
         set @baseCrumbs=(Select Crumbs From [Nt_ProductCategory] where id=@parent)
	end
	...
	insert into [Nt_ProductCategory] (name,parent,depth,crumbs,
clickrate,Display,DisplayOrder,IsDownloadable,Language_Id)values(@name,@parent,
@currentDepth,'',0,@display,@displayorder,0,{lang})
	set @currentID=(select @@IDENTITY)
	update [Nt_ProductCategory] 
