...
begin
	...
	begin
         ...
         set @baseCrumbs=(Select Crumbs From [Nt_Navigation] where id=@parent)
	end
	...
	insert into [Nt_Navigation] (name,parent,depth,crumbs,
Display,DisplayOrder,Language_Id,metatitle,
metakeywords,metadescription,anchortarget,[path],htmlpath)values(@name,@parent,
