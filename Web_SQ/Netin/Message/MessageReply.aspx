...
Inherits="Nt.Pages.Message.MessageReply" %>

<%@ Register Src="~/Netin/Dialog/MessageReplyEdit.ascx" TagPrefix="uc1" TagName="MessageReplyEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_Body" runat="Server">
    ...
    <uc1:MessageReplyEdit runat="server" ID="MessageReplyEdit" />
</asp:Content>
