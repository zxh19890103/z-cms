<%@ Page Title="" Language="C#" MasterPageFile="~/Netin/Layout.master" AutoEventWireup="true"
    Inherits="Nt.Pages.Common.Advert" %>
                        ...
                        <ItemTemplate>
                            <tr id='nt-picture-row-<%#Eval("Id") %>'>
                                <td>
                                    ...
                                    &nbsp;&nbsp;
                    <a href="javascript:void(0)" onclick="deleteThis(<%#Eval("Id") %>)" class="admin-delete" title="删除"></a>
                                ...
                                <td>
                                    ...
                                    <input type="text" maxlength="5" class="input-int32 admin-input-int32" onkeydown="ensureInt32(event)" name="Picture.DisplayOrder" value="<%#Eval("DisplayOrder")  %>" /></td>
                                <td class="td-end">
