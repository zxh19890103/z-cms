<%@ Page Language="C#" MasterPageFile="~/Netin/Layout.master"
    AutoEventWireup="true" Inherits="Nt.Pages.Common.CopyNavigation" %>
    ...
    <div class="admin-main-wrap">
        <div class="admin-main">
            <div class="admin-main-title">
                Copy Navigation Data In Current Language Version To Specified Language Versions
                &nbsp;
                <a href="Navigation.aspx">返回</a>
            </div>
