<%@ Page Title="" Language="C#" MasterPageFile="~/Netin/Layout.master" AutoEventWireup="true"
    Inherits="Nt.Pages.Common.MNavigationEdit" %>
            ...
            <form action="<%=LocalUrl %>" method="post" id="EditForm" name="EditForm" onsubmit="<%=OnSubmitCall() %>">
                <table class="admin-table">
                    ...
                    <tr>
                        ...
                        <td class="right">
                            <textarea cols="30" rows="5" name="MetaKeyWords"><%=Model.MetaKeyWords %></textarea><span class="admin-tips">请勿超过1024个字符。</span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="right">
                            <textarea cols="30" rows="5" name="MetaDescription"><%=Model.MetaDescription %></textarea><span class="admin-tips">请勿超过1024个字符。</span>
                        </td>
                    </tr>
