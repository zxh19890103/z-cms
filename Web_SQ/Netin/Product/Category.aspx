<%@ Page Title="" Language="C#" MasterPageFile="~/Netin/Layout.master" AutoEventWireup="true"
    Inherits="Nt.Pages.Product.Category" %>

<asp:Content ID="Content1" ContentPlaceHolderID="CPH_Head" runat="Server">
    <script type="text/javascript">
        function productTreeMigrate(sender, current) {
            ntAjax({
                method: 'OutputSelections',
                data: '{"from":"' + current + '","type":"1"}',
    ...
    <div class="admin-main-wrap">
        <div class="admin-main">
            <div class="admin-main-title">
                ...
                <%if (IsAdministrator)
                  { %>
                &nbsp;<a href="CategoryEdit.aspx" title="添加根级分类">添加根级分类</a>
                &nbsp;<a href="CopyCategory.aspx" title="将产品目录拷贝至其他语言版本">将产品目录拷贝至其他语言版本</a>
                <%} %>
            </div>
                    ...
                    <ItemTemplate>
                        <tr class="tr-even">
                            ...
                            <td style="text-align: left;">
                                ...
                                <a href="javascript:;" onclick="productTreeMigrate(this,<%#Eval("ID") %>)" class="category-migration">类别迁移</a>
                                <%} %>
                                <a href="Edit.aspx?CategoryId=<%#Eval("Id") %>" class="add-new-record">添加产品</a>
                            </td>
                            <td>
