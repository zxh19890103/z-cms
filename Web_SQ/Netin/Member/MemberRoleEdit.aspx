<%@ Page Title="" Language="C#" MasterPageFile="~/Netin/Layout.master" AutoEventWireup="true"
    Inherits="Nt.Pages.Member.MemberRoleEdit" %>
            ...
            <form id="EditForm" name="EditForm"
                ...
                <table class="admin-table">
                    ...
                    <tr>
                        ...
                        <td class="right">
                            <input type="text" class="input-text" name="SystemName" maxlength="255" value="<%=Model.SystemName %>" />
                    ...
                    <tr>
                        ...
                        <td class="right">
                            <%=HtmlHelper.CheckBox(EnsureEdit?Model.Active:true,"Active",new{}) %>
                        </td>
                    </tr>
                    <tr>
                        <td class="left">描述:</td>
