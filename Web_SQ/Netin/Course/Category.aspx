<%@ Page Title="" Language="C#" MasterPageFile="~/Netin/Layout.master" AutoEventWireup="true" 
    Inherits="Nt.Pages.Course.Category" %>
    ...
    <div class="admin-main-wrap">
        <div class="admin-main">
            <div class="admin-main-title">
                班级类别管理
                <%if(IsAdministrator){ %>
                &nbsp;<a href="CategoryEdit.aspx" title="添加根级类别">添加根级类别</a>
                &nbsp;<a href="CopyCategory.aspx" title="将课程目录拷贝至其他语言版本">将课程目录拷贝至其他语言版本</a>
                <%} %>
                    ...
                    <ItemTemplate>
                        <tr  class="tr-even">
                            ...
                            <td style="text-align: left">
                                ...
                                <%} %>
                                <a href="Edit.aspx?CategoryId=<%#Eval("Id") %>" class="add-new-record">添加课程</a>
                            </td>
                            <td>
